...
it('lets 2 users exchange stars', async() => {
    ...
    let starId1 = 7;
    let starId2 = 8;
    await instance.createStar('Hello World', starId1, {from: user1});
    await instance.createStar('Hello Human', starId2, {from: user2});
...
it('lets a user transfer a star', async() => {
    ...
    let tokenId = 9
    let instance = await StarNotary.deployed();
    await instance.createStar('Hello', tokenId, {from: user1})
