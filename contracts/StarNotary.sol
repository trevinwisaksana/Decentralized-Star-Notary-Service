...
contract StarNotary is ERC721 {
    ...
    // NOTE: ERC721 already has properties named `name` and `symbol`
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require((starOwner1 == msg.sender || starOwner2 == msg.sender), "You are not the owner");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        address ownerAddress = ownerOf(_tokenId);
        require(ownerAddress == msg.sender, "You must be the owner of the star");
